...
<html>
    <head>
        ...
        <title>Nalta Balubas| Welcome</title>
    ...
    <body>
        <header>
            <div class="container">
                <div id="branding">
                    <h1><span class="highlight">Nalta Balubas</span></h1>
                </div>
                <nav>
                    <ul>
                        <li class="current"><a href="index.html">Home</a></li>
                        <li><a href="about.html">Mek/trimtips</a></li>
                        <li><a href="services.html">Bildatabas</a></li>
